        ...
        <div className="relative flex items-center justify-around py-2">
          ...
          {token && (
            <button
              ...
              className="absolute -top-6 right-4 w-14 h-14 rounded-full bg-gradient-to-r from-[#3B82F6] to-[#8B5CF6] text-white shadow-lg shadow-blue-500/40 hover:shadow-blue-500/60 hover:scale-110 transition-all duration-200 flex items-center justify-center z-50"
            >
